export const m = {
  ...
  Delete_announcement_confirm: 'Are you sure to remove this announcement?',
  Delete_classroom_confirm: 'Are you sure to remove this classroom?',
  Keyword: 'Keyword',
  Discussion: 'Discussion',
  Details: 'Details',
  If_you_find_the_following_problem_id_does_not_exist: 'If you find the following problem id does not exist',
  try_to_click_the_button: 'try to click the button',
  ...
  Save_All: 'Save All',
  Is_Receive_Daily_Email: 'Is Receive Daily Email',
  Receive: 'Receive',
  Reject: 'Reject',
  Bookmarks: 'Bookmarks',
