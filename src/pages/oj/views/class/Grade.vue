...
<script>
  ...
  import ContestRankMixin from '@oj/views/contest/children/contestRankMixin'
  ...
  export default {
    ...
    mounted () {
      ...
      console.log('eheere', this.contestID)
    ...
    methods: {
      ...
      getContests () {
        api.getContests(this.data.id).then(resp => {
          ...
          this.contestID = this.contests[0]['id']
        })
      },
